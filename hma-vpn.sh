...
$curl "https://securenetconnection.com/vpnconfig/openvpn-template.ovpn" | sed 's/auth-user-pass/auth-user-pass \/home\/james\/.ssh\/hma.auth/g' > /tmp/hma-config.cfg 2>/dev/null
